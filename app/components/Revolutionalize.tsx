    ...
    return (
        <section ref={ref} className="bg-black flex flex-col lg:h-screen h-[70vh] relative z-50 items-center justify-center overflow-hidden">
            ...
            <div className="flex flex-col lg:gap-0 gap-5 lg:pt-10 pt-5 px-4 lg:px-0 py-12 lg:py-0">
                ...
                <motion.h1
                    style={{ x: slideLeft }}
                    className="text-[3rem] lg:text-[10rem] capitalize font-extrabold text-center flex justify-center lg:justify-center text-[#FFF]/50 lg:h-44 h-10"
                >
                    Revolutionalizing
                </motion.h1>
                ...
                <motion.h1
                    style={{ x: slideLeft }}
                    className="text-[3rem] lg:text-[10rem] capitalize font-extrabold text-center flex justify-center lg:justify-center text-[#FFF]/50"
                >
                    Visualization
                </motion.h1>
